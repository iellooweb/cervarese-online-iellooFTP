			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Sitemap delle località - Cervarese Online</title>
					</xsl:when>
					<xsl:otherwise>
						<title>Sitemap XML - Cervarese Online</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://cervarese-online-ielloo.local/sitemap_index.xml">&#8592; Indice Sitemap</a>							</p>
